#pragma once
//
// MotoTelemetry on-disk ride format, version 1.
//
...
/// 'M','T','L','1' little-endian.
constexpr uint32_t kFileMagic    = 0x314C544Du;
constexpr uint32_t kSummaryMagic = 0x314D544Du;  ///< 'M','T','M','1'
