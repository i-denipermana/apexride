#pragma once
//
// Build-time configuration for ApexRide V1.
//
...
#define APEX_STATUS_LED_PIN 48  ///< onboard addressable LED on the DevKitC-1
...
#define APEX_MAHONY_KP 0.6f
#define APEX_MAHONY_KI 0.02f
...
#define APEX_RECORD_BLOCK_BYTES 4096

/// Total staging buffer. Two blocks, so encoding continues during a flush.
#define APEX_RECORD_BUFFER_BYTES 8192

#define APEX_MAX_FLUSH_INTERVAL_MS 4000
#define APEX_SUMMARY_INTERVAL_MS   10000
...
#define APEX_RIDE_WAITING_ENTER_MS 8000
#define APEX_RIDE_WAITING_ENTER_NO_GNSS_MS 45000
#define APEX_RIDE_WAITING_TIMEOUT_MS 120000
#define APEX_RIDE_SLEEP_TIMEOUT_MS   300000

// ---------------------------------------------------------------------------
// Storage
// ---------------------------------------------------------------------------

#define APEX_RIDES_DIRECTORY "/rides"

/// Recording will not start below this much free space.
#define APEX_MIN_FREE_BYTES_TO_START (512u * 1024u)
